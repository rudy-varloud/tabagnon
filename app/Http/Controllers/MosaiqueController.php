...
class MosaiqueController extends Controller {
    ...
    public function postPhotoMosaique() {
        ...
        $erreur = 'Votre image a bien été ajouté cependant elle doit être validé par un administrateur';
        ...
        $uneMosaique = new Mosaique();
        $mesMosaiques = $uneMosaique->listeMosaique();
        return view('/Mosaique/pageMosaique', compact('mesMosaiques', 'erreur'));
    }
