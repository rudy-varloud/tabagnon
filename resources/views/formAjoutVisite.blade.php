...
<script>
    function verifGuide()
            var test = $('.nomGuideVis').val();
    var test2 = $('.nomGuideVisMan').val();
    if ((test2 === '') && (test !== null)) {
        alert('bonjour');
        $('.nomGuideVisMan').removeAttr('required');
        $('.nomGuideVis').attr('required');
    } else if ((test === null) && (test2 !== '')) {
        alert('Skurtskurt');
        $('.nomGuideVis').removeAttr('required');
        $('.nomGuideVisMan').attr('required');
    } else {
    ...
    <div class="col-lg-12 col-md-12 col-s-12 box">
        ...
        <div class='form-group'>
            ...
            <div class="form-group">
                ...
                <input name="nomGuideVisMan" class="form-control nomGuideVisMan" type="text" placeholder="Nom guide" value='' required>
            </div>
        </div>
        <br>
        <div class="form-group">
