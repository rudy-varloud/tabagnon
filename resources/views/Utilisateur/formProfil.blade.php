            ...
            <div class="form-horizontal">   
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-3">
                            <input type='text' name='mail' pattern=".{5,65}" value='{{$unV->mailVis or ''}}' class='form-control' placeholder="Votre adresse e-mail" required >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-3">
                            <input type='text' name='adressecli' value='{{$unV->adresseVis or ''}}' placeholder="Votre adresse" class='form-control' required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-3">
                            <input type='password' name='mdp' value='{{$mdp_decrypt}}' class='form-control mdp' id="0" required >
                        </div>
                        <div class="verifMdp">
